                    ...
                    fade: {
                        ...
                        setTranslate: function () {
                            ...
                            if (T.wrapper.css({
                                ...
                                }), T.params.cube.shadow)if (i())e.transform("translate3d(0px, " + (T.width / 2 + T.params.cube.shadowOffset) + "px, " + -T.width / 2 + "px) rotateX(360deg) rotateZ(0deg) scale(" + T.params.cube.shadowScale + ")"); else {
                                ...
                                e.transform("scale3d(" + v + ", 1, " + w + ") translate3d(0px, " + (T.height / 2 + y) + "px, " + -T.height / 2 / w + "px) rotateX(-360deg)")
                            }
